              ...
              child: (
                  Column(
                    ...
                    children: [
                      ...
                      Column(
                        children: [
                          Text('Rs 2,00,000/- + 18% GST', style: TextStyle(
                              fontSize: 16
                          ),
                          )
                        ],
                      ...
                      Row(
                        children: [
                          ...
                          SizedBox(width: 10,),
                          Text('120 Slides', style: TextStyle(fontWeight: FontWeight.w900),),
                      ...
                      Row(
                        children: [
                          Icon(Icons.arrow_circle_right_outlined, color: Colors.blue[700],),
                          SizedBox(width: 10,),
                          Text('30 Reels', style: TextStyle(fontWeight: FontWeight.w900),),
                          Text(' will be provided throughout the tenure'),
                      ...
                      Container(
                        ...
                        child: Center(
                          child: Text(
                              "Ellostar's commission is 10% = Rs 20,000/- "
                          ),
                        ),
                      )
