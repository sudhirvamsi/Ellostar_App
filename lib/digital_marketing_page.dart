                    ...
                    Padding(
                      ...
                      child: Container(
                        child: Column(
                          ...
                          children: [
                            Text('Digital Marketing', style: TextStyle(
                              fontSize: 20,
                              fontWeight: FontWeight.bold
                            ),),
                            SizedBox(height: 15,),
                            Text("Digital marketing transforms businesses by providing comprehensive strategies that enhance visibility, engagement, and growth across all digital platforms. "
                          ...
                          Row(
                            children: [
                              ...
                              Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text('Search Engine Optimization', style: TextStyle(
                                      fontSize: 18, fontWeight: FontWeight.bold
                                  ),),
                                  SizedBox(height: 10,),
                                  Text('Your Path to Higher Rankings', style: TextStyle(
                                    fontSize: 12,
                                  ),),
                                ],
                              ),
                          ...
                          Row(
                            children: [
                              ...
                              Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text('Social Media Optimization', style: TextStyle(
                                      fontSize: 18, fontWeight: FontWeight.bold
                                  ),),
                                  SizedBox(height: 10,),
                                  Text('Your Path to Higher Rankings', style: TextStyle(
                          ...
                          Row(
                            children: [
                              ...
                              Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text('Search Engine Marketing', style: TextStyle(
                                      fontSize: 18, fontWeight: FontWeight.bold
                                  ),),
                                  SizedBox(height: 10,),
                                  Text('Your Path to Higher Rankings', style: TextStyle(
                          ...
                          Row(
                            children: [
                              ...
                              Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text('Social Media Marketing', style: TextStyle(
                                      fontSize: 18, fontWeight: FontWeight.bold
                                  ),),
                                  SizedBox(height: 10,),
                                  Text('Your Path to Higher Rankings', style: TextStyle(
