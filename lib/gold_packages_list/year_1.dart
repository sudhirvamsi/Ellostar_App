              ...
              child: (
                  Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          Container(
                            ...
                            child: (
                                Text('SAVE 30.5%', style: TextStyle(
                      ...
                      Column(
                        children: [
                          Text('Rs 5,00,000/- + 18% GST', style: TextStyle(
                              fontSize: 16
                          ),
                          )
                        ],
                      ...
                      Container(
                        ...
                        child: Center(
                          child: Text(
                              "Ellostar's commission is 10% = Rs 50,000/- "
                          ),
                        ),
                      )
